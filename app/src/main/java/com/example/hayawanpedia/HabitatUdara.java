...
public class HabitatUdara extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_habitat_udara);

        DBKoneksi = FirebaseDatabase.getInstance().getReference("udara");
        ...
        listViewContact.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent tampil_data_darat = new Intent(HabitatUdara.this, DataUdara.class);
    ...
    private void readData() {
        ...
        DBKoneksi.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ListViewAdapter adapter = new ListViewAdapter(id, indo, arab, penjelasan, foto, HabitatUdara.this);
